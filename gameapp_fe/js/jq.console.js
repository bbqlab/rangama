...
(function($){
  $.console = {
    ...
    init: function(options){
      ...
      console.log("Init jqMobi console!");
    ...
    add_console: function(){
      ...
      $('body').append('<ul id="jq_console"></ul>');
      this.console = $('#jq_console');
    },
    ...
    toggle_console: function(){
      if($.console.visible)
      {
        $.console.console.removeClass('jq_console_show');
        $.console.visible = false;
      }
      else{
        $.console.console.addClass('jq_console_show');
